...
The Free Birds API offers accessible endpoints to retrieve and manage various bird data ideal for development purposes.

Learn more about Free Birds API at [freetestapi.com](https://freetestapi.com).
...
This SDK exposes the API as a small set of **semantic entities** — Bird — that you
