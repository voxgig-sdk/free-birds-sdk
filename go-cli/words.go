...
func registerSDKWords(r *eng.Registry, client *sdk.FreeBirdsSDK) {
...
func runOp(client *sdk.FreeBirdsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
