...
type Args struct {
	Entity string         `json:"entity" jsonschema:"bird"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FreeBirdsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-birds_list",
		Description: "List records from FreeBirds. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-birds_load",
		Description: "Load a single record from FreeBirds. " +
...
func runOp(client *sdk.FreeBirdsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FreeBirdsSDK, name string) (sdk.FreeBirdsEntity, error) {
	switch strings.ToLower(name) {
	case "bird":
		return client.Bird(nil), nil
