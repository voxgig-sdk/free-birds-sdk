...
// FreeBirds SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FreeBirdsMakeRequest
{
    public static function call(FreeBirdsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FreeBirdsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FreeBirdsResponse($fetched);
        } else {
