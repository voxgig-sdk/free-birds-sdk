...
// FreeBirds SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FreeBirdsTransformResponse
{
    public static function call(FreeBirdsContext $ctx): mixed
    {
        ...
        $transform = FreeBirdsHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
