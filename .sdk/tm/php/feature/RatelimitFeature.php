...
// FreeBirds SDK ratelimit feature
...
class FreeBirdsRatelimitFeature extends FreeBirdsBaseFeature
{
    ...
    private function _acquire(FreeBirdsContext $ctx): void
    {
    ...
    private function _track(FreeBirdsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
