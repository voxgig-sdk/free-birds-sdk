...
class FreeBirdsCacheFeature extends FreeBirdsBaseFeature
{
    ...
    private function _through(FreeBirdsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
