...
class FreeBirdsRbacFeature extends FreeBirdsBaseFeature
{
    ...
    private function _required(FreeBirdsContext $ctx): ?string
    {
    ...
    private function _reject(FreeBirdsContext $ctx, string $required): void
    {
    ...
    private function _track(FreeBirdsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
