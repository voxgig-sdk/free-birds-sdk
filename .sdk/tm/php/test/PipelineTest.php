...
{
    private static function utility(): FreeBirdsUtility
    {
        return new FreeBirdsUtility();
    }
    ...
    private static function ctx(array $over = []): FreeBirdsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new FreeBirdsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new FreeBirdsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof FreeBirdsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new FreeBirdsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = FreeBirdsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new FreeBirdsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = FreeBirdsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new FreeBirdsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = FreeBirdsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FreeBirdsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = FreeBirdsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new FreeBirdsResponse([]),
            'result' => new FreeBirdsResult([]),
        ]);
        [, $err] = FreeBirdsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new FreeBirdsSpec([]),
            'response' => null,
            'result' => new FreeBirdsResult([]),
        ]);
        [, $err] = FreeBirdsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new FreeBirdsSpec(['step' => 's']),
            'response' => new FreeBirdsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new FreeBirdsResult([]),
        ]);
        [, $err] = FreeBirdsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new FreeBirdsSpec(['step' => 's']),
            'response' => new FreeBirdsResponse(self::resp(200, ['v' => 1])),
            'result' => new FreeBirdsResult([]),
        ]);
        [, $err] = FreeBirdsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new FreeBirdsSpec(['step' => 's']),
            'response' => new FreeBirdsResponse(self::resp(200, ['v' => 2])),
            'result' => new FreeBirdsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        FreeBirdsMakeResponse::call($ctx);
    ...
    {
        $preset = new FreeBirdsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new FreeBirdsSpec([]),
            'response' => new FreeBirdsResponse([]),
            'result' => new FreeBirdsResult([]),
        ...
        [$got, $err] = FreeBirdsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new FreeBirdsResult([])]);
        [, $err] = FreeBirdsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new FreeBirdsSpec([]), 'result' => null]);
        [, $err] = FreeBirdsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FreeBirdsSpec(['step' => 's']),
            'result' => new FreeBirdsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new FreeBirdsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FreeBirdsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FreeBirdsSpec(['step' => 's']),
            'result' => new FreeBirdsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new FreeBirdsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FreeBirdsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FreeBirdsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new FreeBirdsSpec([]),
            'result' => new FreeBirdsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = FreeBirdsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FreeBirdsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new FreeBirdsError('boom', 'boom');
        $utility->fetcher = function (FreeBirdsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FreeBirdsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = FreeBirdsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (FreeBirdsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = FreeBirdsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(FreeBirdsResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (FreeBirdsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FreeBirdsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = FreeBirdsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new FreeBirdsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new FreeBirdsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = FreeBirdsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = FreeBirdsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = FreeBirdsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new FreeBirdsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, FreeBirdsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new FreeBirdsResult(['ok' => false])]);
        $this->expectException(FreeBirdsError::class);
        FreeBirdsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new FreeBirdsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', FreeBirdsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        FreeBirdsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new FreeBirdsBaseFeature();
        $b = new FreeBirdsBaseFeature();
        FreeBirdsFeatureAdd::call($ctx, $a);
        FreeBirdsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): FreeBirdsBaseFeature
    {
        $f = new FreeBirdsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        FreeBirdsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): FreeBirdsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new FreeBirdsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FreeBirdsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new FreeBirdsResponse(['headers' => null]),
            'result' => new FreeBirdsResult([]),
        ]);
        FreeBirdsResultHeaders::call($ctx);
