...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.FREEBIRDS_TEST_LIVE ||
    'TRUE' === process.env.FREEBIRDS_TEST_OVERRIDE
  ) {
  ...
  m.FREEBIRDS_TEST_EXPLAIN = process.env.FREEBIRDS_TEST_EXPLAIN || m.FREEBIRDS_TEST_EXPLAIN
