# FreeBirds TypeScript SDK Reference

Complete API reference for the FreeBirds TypeScript SDK.
...
```ts
new FreeBirdsSDK(options?: object)
```
...
#### `FreeBirdsSDK.test(testopts?, sdkopts?)`
...
**Returns:** `FreeBirdsSDK` instance in test mode.
...
Return the parent `FreeBirdsSDK` instance.
