# FreeBirds Golang SDK Reference

Complete API reference for the FreeBirds Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *FreeBirdsSDK`
...
#### `Bird(data map[string]any) FreeBirdsEntity`
