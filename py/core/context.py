...
class FreeBirdsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, FreeBirdsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FreeBirdsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FreeBirdsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FreeBirdsError(code, msg, self)
