# FreeBirds SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FreeBirdsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FreeBirdsSDK(...) and FreeBirdsSDK.test(...) become
#      FreeBirdsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "freebirds_sdk"
_SDK_CLASS = "FreeBirdsSDK"
