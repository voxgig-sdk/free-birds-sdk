...
class FreeBirdsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeBirdsTestRunner.getenv("FREEBIRDS_TEST_LIVE")
        override = FreeBirdsTestRunner.getenv("FREEBIRDS_TEST_OVERRIDE")
        ...
        explain = FreeBirdsTestRunner.getenv("FREEBIRDS_TEST_EXPLAIN")
