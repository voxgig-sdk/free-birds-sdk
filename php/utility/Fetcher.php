...
// FreeBirds SDK utility: fetcher

class FreeBirdsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FreeBirdsSDK/1.0)';
    ...
    public static function call(FreeBirdsContext $ctx, string $fullurl, array $fetchdef): array
    {
