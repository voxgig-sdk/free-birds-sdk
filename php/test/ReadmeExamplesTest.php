...
// FreeBirds SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FreeBirdsSDK::test)
...
{
    private const SDK_CLASS = 'FreeBirdsSDK';
    ...
    private const SDK_BASE = 'freebirds_sdk';
