...
class FreeBirdsProxyFeature extends FreeBirdsBaseFeature
{
    ...
    public function init(FreeBirdsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FreeBirdsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
