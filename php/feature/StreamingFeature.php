...
// FreeBirds SDK streaming feature
...
class FreeBirdsStreamingFeature extends FreeBirdsBaseFeature
{
    ...
    private function _iterate(FreeBirdsResult $result): \Generator
    {
    ...
    private function _streamable(FreeBirdsContext $ctx): bool
    {
