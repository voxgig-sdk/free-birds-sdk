...
// FreeBirds SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FreeBirdsTestFeature extends FreeBirdsBaseFeature
{
    ...
    public function init(FreeBirdsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FreeBirdsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = FreeBirdsParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FreeBirdsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FreeBirdsContext $ctx, $op, $args): array
    {
