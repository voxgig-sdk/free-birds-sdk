...
// FreeBirds SDK clienttrack feature
...
class FreeBirdsClienttrackFeature extends FreeBirdsBaseFeature
{
    ...
    public function PostConstruct(FreeBirdsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FreeBirds-SDK';
