...
class FreeBirdsNetsimFeature extends FreeBirdsBaseFeature
{
    ...
    private function _simulate(FreeBirdsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FreeBirdsContext $ctx, array $applied): void
    {
        $client = $this->client;
