...
class FreeBirdsTimeoutFeature extends FreeBirdsBaseFeature
{
    ...
    private function _with_timeout(FreeBirdsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FreeBirdsContext $_ctx, float $ms): void
    {
        $client = $this->client;
