...
The Ruby SDK for the FreeBirds API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `FreeBirdsError` (a `StandardError` subclass), so wrap
...
```
rb/
├── FreeBirds_sdk.rb       -- Main SDK module
