...
require_relative 'FreeBirds_types'
...
class FreeBirdsSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = FreeBirdsHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = FreeBirdsHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, FreeBirdsFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    FreeBirdsUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = FreeBirdsHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = FreeBirdsHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = FreeBirdsHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def direct(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = FreeBirdsHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
